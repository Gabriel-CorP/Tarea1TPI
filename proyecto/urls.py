...
urlpatterns = [
    ...
    path('cadena-de-caracteres/', views.cadena-de-caracteres, name='cadena-de-caracteres'),
    path('cadena-de-caracteres/operaciones-con-cadenas', views.operaciones-con-cadenas, name='operaciones-con-cadenas'),
    path('cadena-de-caracteres/representacion-de-cadenas', views.representacion-de-cadenas, name='representacion-de-cadenas'),
