...
urlpatterns = [
    ...
    path('programacion_web/apis/', views.apis, name="apis"),
    path('POO/', views.POO, name='POO'),
    path('cadena_de_caracteres/', views.cadenaDeCaracteres, name='cadena-de-caracteres'),
    path('cadena_de_caracteres/operaciones_con_cadenas/', views.operacioneesConCadenas, name='operaciones_con_cadenas'),
    path('cadena_de_caracteres/representacion_de_cadenas/', views.representacionDeCadenas, name='representacion_de_cadenas'),
