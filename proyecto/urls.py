...
urlpatterns = [
    ...
    path('cadena-de-caracteres/', views.cadenaDeCaracteres, name='cadena-de-caracteres'),
    path('cadena-de-caracteres/operaciones-con-cadenas', views.operacioneesConCadenas, name='operaciones-con-cadenas'),
    path('cadena-de-caracteres/representacion-de-cadenas', views.representacionDeCadenas, name='representacion-de-cadenas'),
